...
const ThemeSelector = memo(() => {
  ...
  return (
    <XStack gap={10} justifyContent="center">
      <Button themeInverse onPress={() => setThemeName('light')} opacity={currentTheme === 'light' ? 0.5 : 1}>
        Light Theme
      </Button>
      <Button themeInverse onPress={() => setThemeName('dark')} opacity={currentTheme === 'dark' ? 0.5 : 1}>
        Dark Theme
      </Button>
    </XStack>
  );
