    ...
    <ThemedView>
      <YStack gap="$2">
        <XStack gap="$2" alignItems="center">
          <H3 padding="$4" color="$color">Trending</H3>
          <H3 padding="$4" color="$color">Popular</H3>
        </XStack>
        {isLoading && !data ? (
          ...
          <CardList data={data} refetch={refetch} fetchNextPage={fetchNextPage} hasNextPage={hasNextPage} isLoading={isLoading}/>
        )}
      </YStack>
    </ThemedView>
  );
